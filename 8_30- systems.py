...
while (answer == "empty"):
  ...
  if(userchoice == "1"):
    ...
    print("Change management means shifting, hiring, or letting go of employees or whole departments, or maybe changing a system's process or the work it does. It should maximize benefits and minimize negatives, for all stakeholders, including the employees.")
  elif(userchoice == "6"):
    print("A business merger is an agreement that unites two existing companies into one new company.")
  elif(userchoice == "7"):
